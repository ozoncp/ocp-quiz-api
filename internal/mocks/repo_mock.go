...
// Source: github.com/ozoncp/ocp-quiz-api/internal/repo (interfaces: Repo)
...
import (
	...
	models "github.com/ozoncp/ocp-quiz-api/internal/models"
)
...
func (m *MockRepo) AddEntity(arg0 context.Context, arg1 models.Quiz) (uint64, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 context.Context, arg1 uint64) (*models.Quiz, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0 context.Context, arg1, arg2 uint64) ([]models.Quiz, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) RemoveEntity(arg0 context.Context, arg1 uint64) bool {
	m.ctrl.T.Helper()
