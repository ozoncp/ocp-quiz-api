...
COPY . /home/developer/go/src/github.com/ozoncp/ocp-quiz-api
RUN echo developer | sudo -S chown -R developer /home/developer/

WORKDIR /home/developer/go/src/github.com/ozoncp/ocp-quiz-api
...
WORKDIR /root/
COPY --from=builder /home/developer/go/src/github.com/ozoncp/ocp-quiz-api/bin/ocp-quiz-api .
RUN chown root:root ocp-quiz-api
EXPOSE 82
