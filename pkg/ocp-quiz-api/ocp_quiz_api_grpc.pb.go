...
type OcpQuizApiServiceClient interface {
	...
	UpdateQuiz(ctx context.Context, in *UpdateQuizV1Request, opts ...grpc.CallOption) (*UpdateQuizV1Response, error)
}
...
func (c *ocpQuizApiServiceClient) UpdateQuiz(ctx context.Context, in *UpdateQuizV1Request, opts ...grpc.CallOption) (*UpdateQuizV1Response, error) {
	out := new(UpdateQuizV1Response)
	err := c.cc.Invoke(ctx, "/ocp.quiz.api.OcpQuizApiService/UpdateQuiz", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OcpQuizApiServiceServer interface {
	...
	// UpdateQuiz updates quiz data
	UpdateQuiz(context.Context, *UpdateQuizV1Request) (*UpdateQuizV1Response, error)
...
func (UnimplementedOcpQuizApiServiceServer) UpdateQuiz(context.Context, *UpdateQuizV1Request) (*UpdateQuizV1Response, error) {
...
func _OcpQuizApiService_UpdateQuiz_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateQuizV1Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OcpQuizApiServiceServer).UpdateQuiz(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ocp.quiz.api.OcpQuizApiService/UpdateQuiz",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OcpQuizApiServiceServer).UpdateQuiz(ctx, req.(*UpdateQuizV1Request))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OcpQuizApiService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _OcpQuizApiService_UpdateQuiz_Handler,
		},
	},
